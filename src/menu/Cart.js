                    ...
                    <div id="cart">
                        <div className="cart_content">
                            ...
                            <div className="cart_foot">
                                ...
                                <button type="button" className="btn btn-outline-light"><Link to="/Payment" style={{color:"white"}}>Pay with Credit</Link></button>
                                <button type="button" className="btn btn-outline-light"><Link to="/Payment2" style={{color:"white"}}>Pay with UPI</Link></button>
</div>                  
                            </div>
                        </div>
                    </div>
